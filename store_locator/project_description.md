...
Build a production-ready Store Locator API service for a multi-location retail business. 
The system supports public store search functionality and secure internal store management with role-based access control.
